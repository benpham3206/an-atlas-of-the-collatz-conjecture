...
| **Certificate generation, formalization, enumeration** | Claude (Anthropic), GPT-5.x (OpenAI), Kimi (Moonshot AI) | Proof drafting, exact-arithmetic verifiers, Lean formalization, exhaustive enumeration, packet prose. |
