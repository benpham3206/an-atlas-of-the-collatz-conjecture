...
| D2 Terras bijection | PASS | 4.490 | For each k≤20, φ_k : Z/2^k Z → {0,1}^k, φ_k([n]) = length-k parity word of a positive lift of [n], is bijective. |
| D3 cycle-candidate sweep | PASS | 52.443 | max_L=24 examined=1321649 pruned_growth=3254690 skipped_necklace=28978091 integral=12 verified=12 ns=[2] |
| D4 stopping-time spectrum | PASS | 1.168 | limit=1048576 stop_max=183@n=1027431 p50=1 p99=32 total_max=329@n=837799 tp50=85 tp99=181 |
